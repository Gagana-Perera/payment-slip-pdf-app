        ...
        <main class="control-panel staggered-1">
          <header class="panel-header" style="display: flex; justify-content: space-between; align-items: flex-start;">
            ...
            <div style="display: flex; gap: 0.5rem; flex-direction: column; align-items: flex-end;">
              <a href="/add-user" class="btn-generate" style="padding: 0.6rem 1.2rem; font-size: 0.85rem; background: rgba(99, 102, 241, 0.15); border-color: rgba(99, 102, 241, 0.4); text-decoration: none;">
                <span class="btn-content" style="color: #a5b4fc;">
